      ...
      <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div className="grid row-gap-10 mb-8 lg:grid-cols-6">
          <div className="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4 md:grid-cols-4">
            <div>
              ...
              <ul className="mt-2 space-y-2">
                <li>
                  <a
                    href="/"
                    className="text-light transition-colors duration-300 hover:text-deep-purple-accent-200"
                  >
                    Graphiste
                  </a>
                </li>
            ...
            <div>
              <p className="font-medium tracking-wide text-white">Localisations</p>
              <ul className="mt-2 space-y-2">
                <li>
                  <a
                    href="/"
          ...
          <div className="md:max-w-md lg:col-span-2">
            ...
            <form className="flex flex-col mt-4 md:flex-row">
              <input
                ...
                required
                type="text"
                className="flex-grow w-full h-12 px-4 mb-3 transition duration-200 bg-white border border-white rounded shadow-sm appearance-none md:mr-2 md:mb-0 focus:border-deep-purple-accent-400 focus:outline-none focus:shadow-outline"
              />
              <button
                type="submit"
            ...
            <p className="mt-4 text-sm text-light">
              En souscrivant à notre boite aux lettres, vous acceptez de recevoir nos annonces ainsi que nouvelles.
            </p>
          </div>
        </div>
        <div className="flex flex-col justify-between pt-5 pb-10 border-t border-light sm:flex-row">
          ...
          <div className="flex items-center mt-4 space-x-4 sm:mt-0">
            <a
              href="/"
              className="text-light transition-colors duration-300 hover:text-teal-accent-400"
            >
